...
//
//
    public function listarUm($Triagem){
        $conexao = Conexao::pegarConexao();
        $querySelect = "SELECT * FROM tbtriagem INNER JOIN tbocorrencia on 
        (tbtriagem.codPaciente = tbocorrencia.codPaciente) INNER JOIN tbpaciente on
        (tbocorrencia.codPaciente = tbpaciente.codPaciente) 
         where tbtriagem.codPaciente 
        like '".$Triagem->getCodPaciente()."' AND statusOcorrencia like 'consulta'";
