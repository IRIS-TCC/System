...
<body style="width: 100%; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;">
    ...
    <p style="text-align:justify;  margin-top: 10%; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif; font-size: 19px;">
        Durante a consulta, o paciente apresentou sintomas de gripe, sendo eles, coriza, tosse e teve febre durante a madrugada do dia 15, podendo assim estar somente com um resfriado, ou com COVID-19, foi pedido um exame para que seja descartada a possibilidade ser COVID-19.
    </p>
