<?php
    ...
    $teste = "paciente bla bla bla bla";
...
<body style='width: 100%; font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;'>
    ...
    <p>Novalgina 500 mg -------------------------------</p>
    <p>Tomar 01 comprimido via oral de 6/6 horas</p>
    <p>Durante 7 dias</p>
    <br>
    <p>Profenid 100 mg -------------------------------</p>
    <p>Tomar 01 comprimido via oral de 12/12 horas</p>
    <p>Durante 5 dias</p>
