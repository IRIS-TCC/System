...
// 
    public function cadastrar($Paciente){
        ...
        ('".$Paciente->getNomePaciente()."'
            , '".$Paciente->getNomeSocialPaciente()."'
            , '".$Paciente->getDataNascimentoPaciente()."'
            , '".$Paciente->getRgPaciente()."'
            , '".$Paciente->getCpfPaciente()."'
            , '".$Paciente->getSexoPaciente()."'
            , '".$Paciente->getNumCartaoSusPaciente()."'
            , '".$Paciente->getNacionalidadePaciente()."'
            , '".$Paciente->getNomeMaePaciente()."'
            , '".$Paciente->getLogradouroPaciente()."'
            , '".$Paciente->getCidadePaciente()."'
            , '".$Paciente->getBairroPaciente()."'
            , '".$Paciente->getCepPaciente()."'
            , '".$Paciente->getNumCasaPaciente()."'
            , '".$Paciente->getMunicipioPaciente()."'
            , '".$Paciente->getTipoLogradouroPaciente()."'
            , '".$Paciente->getEmail()."'
            , '".$Paciente->getComplementoPaciente()."'
            , '".$Paciente->getReferenciaLogradouro()."'
        )";
