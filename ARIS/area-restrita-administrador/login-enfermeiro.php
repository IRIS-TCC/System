<html>
    ...
    <head>
        ...
        <meta charset="utf-8">
        <title>ARIS - CADASTRO LOGIN ENFERMEIRO</title>
		...
		<script type="text/javascript">
			function mascaraCPF(){
				var cpf = document.getElementById("cpf-login-enfermeiro")
            ...
            function validaCPF(){
				var cpf = document.getElementById("cpf-login-enfermeiro").value
    ...
    <body>
        ...
        <section class="main">
            <div class="titulo-descricao-main">
                <h2>CADASTRO LOGIN ENFERMEIRO</h2>
                <hr>
            </div>
            <div class="login-enfermeiro-adm">
                <form action=<?php echo $_SERVER ['PHP_SELF']; ?> class="form-formularios" onsubmit="return validaCPF()">
                    <div class="input-container campo-form-solitario">
                        <input id="cpf-login-enfermeiro" name="cpf" class="input-form" type="text" pattern=".+" required maxlength="14" onkeydown="mascaraCPF()"  />
                        <label class="label-form" for="cpf-login-enfermeiro">CPF<sup>*</sup></label>
                    </div>
                    <button value="pesquisar" name="btnPesquisar" type="submit" class="search-btn-form"><i class="fas fa-search"></i></button>
                </form>
                <form action="classes/enfermeiro/cadastrarLoginEnfermeiro.php" method="POST" class="form-formularios">        
                    
                    <input value="<?php echo $codFuncionario;?>" type="hidden" name="codfuncionario" />
                    <div class="input-container campo-form-lado-a-lado">
                        <input maxlength="40" name="nomecompletousuario" value="<?php if (empty($nomeFuncionario)){echo"Insira o CPF primeiro";}else{echo $nomeFuncionario;}?>" id="nome-completo-login-enfermeiro" class="input-form" type="text" pattern=".+" required />
                        <label class="label-form" for="nome-completo-login-enfermeiro">Nome Completo<sup>*</sup></label>
                    </div>
                    <div class="input-container campo-form-lado-a-lado">
                        <input maxlength="20" id="usuario-login-enfermeiro" name="nomeusuario" class="input-form" type="text" pattern=".+" required />
                        <label class="label-form" for="usuario-login-enfermeiro">Usuário<sup>*</sup></label>
                    </div>
                    <div class="input-container campo-form-lado-a-lado">
                        <input maxlength="20" id="senha-login-enfermeiro" name="senhausuario" class="input-form" type="password" pattern=".+" required />
                        <label class="label-form" for="senha-login-enfermeiro">Senha<sup>*</sup></label>
                    </div>
                    <div class="input-container campo-form-lado-a-lado">
                        <input maxlength="20" id="confirmar-senha-login-enfermeiro" name="confirmarsenhausuario" class="input-form" type="password" pattern=".+" required />
                        <label class="label-form" for="confirmar-senha-login-enfermeiro">Confirmar Senha<sup>*</sup></label>
                    </div>
                    <div class="input-container campo-form-direita">
                        <button type="submit" name="btnCadastrar" class="geral-btn-form">Salvar</button>
                    </div>
                </form>
                <script>
                    var password = document.getElementById("senha-login-enfermeiro")
                    , confirm_password = document.getElementById("confirmar-senha-login-enfermeiro");
